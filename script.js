...
function autoPlay() {
  if (!isAutoPlaying) {
    ...
    isAutoPlaying = true;
    document.querySelector(".auto-play-button-js").innerHTML = "Stop Playing";
  } else {
...
document.querySelector(".auto-play-button-js").addEventListener("click", () => {
  autoPlay();
});
...
function showResetConfirmation() {
  document.querySelector(".js-rest-confirmation").innerHTML = `
